...
def initConfig(controllerObject):
    ...
    paramsList = [{"CMD_OPTION"      : "ssh-public-key",
                   ...
                   "NEED_CONFIRM"    : False,
                   "CONDITION"       : False },
                  {"CMD_OPTION"      : "os-pgsql-install",
                   "USAGE"           : "Set to 'y' if you would like Packstack to install PostgreSQL",
                   "PROMPT"          : "Should Packstack install PostgreSQL DB",
                   "OPTION_LIST"     : ["y", "n"],
                   "VALIDATORS"      : [validators.validate_options],
                   "DEFAULT_VALUE"   : "y",
                   "MASK_INPUT"      : False,
                   "LOOSE_VALIDATION": False,
                   "CONF_NAME"       : "CONFIG_PGSQL_INSTALL",
                   "USE_DEFAULT"     : False,
                   "NEED_CONFIRM"    : False,
                   "CONDITION"       : False },
                  ...
                  {"CMD_OPTION"      : "nagios-install",
                   ...
                   "OPTION_LIST"     : ["y", "n"],
                   "VALIDATORS"      : [validators.validate_options],
                   # Bevis : 2014.5.19 : set nagios default value = n
                   "DEFAULT_VALUE"   : 'n',
                   "MASK_INPUT"      : False,
                   "LOOSE_VALIDATION": False,
...
def discover(config):
    ...
    for host in filtered_hosts(config):
        ...
        # Bevis : change to ubuntu release file
        server.append('cat /etc/issue.net')
        try:
