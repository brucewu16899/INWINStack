    ...
    conf_params = {
        ...
        "NEUTRON_OVS_PLUGIN_AND_AGENT" : [
            {"CMD_OPTION"      : "neutron-ovs-bridge-mappings",
             ...
             "OPTION_LIST"     : [],
             "VALIDATORS"      : [],
             "DEFAULT_VALUE"   : "public_subnet:br-ex",
             "MASK_INPUT"      : False,
             "LOOSE_VALIDATION": True,
            ...
            {"CMD_OPTION"      : "neutron-ovs-bridge-interfaces",
             ...
             "OPTION_LIST"     : [],
             "VALIDATORS"      : [],
             "DEFAULT_VALUE"   : "br-ex:eth0,br-int:eth1",
             "MASK_INPUT"      : False,
             "LOOSE_VALIDATION": True,
        ...
        "NEUTRON_ML2_PLUGIN" : [
            ...
            {"CMD_OPTION"      : "neutron-l2-agent", # We need to ask for this only in case of ML2 plugins
             ...
             "NEED_CONFIRM"    : False,
             "CONDITION"       : False },
            {"CMD_OPTION"      : "ext-net-ip-range",
             "USAGE"           : "The CIDR network address for the external network subnet",
             "PROMPT"          : "Enter the CIDR of external network subnet",
             "OPTION_LIST"     : False,
             "VALIDATORS"      : False,
             "DEFAULT_VALUE"   : "172.20.0.0/16",
             "MASK_INPUT"      : False,
             "LOOSE_VALIDATION": False,
             "CONF_NAME"       : "CONFIG_EXT_NET_IP_RANGE",
             "USE_DEFAULT"     : False,
             "NEED_CONFIRM"    : False,
             "CONDITION"       : False },
            {"CMD_OPTION"      : "ext-net-gw-ip",
             "USAGE"           : "The gateway address for the external network",
             "PROMPT"          : "Enter the gateway of external network",
             "OPTION_LIST"     : False,
             "VALIDATORS"      : False,
             "DEFAULT_VALUE"   : "172.20.0.1",
             "MASK_INPUT"      : False,
             "LOOSE_VALIDATION": False,
             "CONF_NAME"       : "CONFIG_EXT_NET_GW_IP",
             "USE_DEFAULT"     : False,
             "NEED_CONFIRM"    : False,
             "CONDITION"       : False },
            {"CMD_OPTION"      : "ext-net-ip-start",
             "USAGE"           : "Start address for the external network",
             "PROMPT"          : "Enter start address of external network",
             "OPTION_LIST"     : False,
             "VALIDATORS"      : False,
             "DEFAULT_VALUE"   : "172.20.100.10",
             "MASK_INPUT"      : False,
             "LOOSE_VALIDATION": False,
             "CONF_NAME"       : "CONFIG_EXT_NET_IP_START",
             "USE_DEFAULT"     : False,
             "NEED_CONFIRM"    : False,
             "CONDITION"       : False },
            {"CMD_OPTION"      : "ext-net-ip-end",
             "USAGE"           : "End address for the external network",
             "PROMPT"          : "Enter end address of external network",
             "OPTION_LIST"     : False,
             "VALIDATORS"      : False,
             "DEFAULT_VALUE"   : "172.20.100.200",
             "MASK_INPUT"      : False,
             "LOOSE_VALIDATION": False,
             "CONF_NAME"       : "CONFIG_EXT_NET_IP_END",
             "USE_DEFAULT"     : False,
             "NEED_CONFIRM"    : False,
             "CONDITION"       : False },
            {"CMD_OPTION"      : "ext-net-public-if",
             "USAGE"           : "Public network binded NIC name",
             "PROMPT"          : "Enter Public network bind NIC name",
             "OPTION_LIST"     : False,
             "VALIDATORS"      : False,
             "DEFAULT_VALUE"   : "eth0",
             "MASK_INPUT"      : False,
             "LOOSE_VALIDATION": False,
             "CONF_NAME"       : "CONFIG_EXT_NET_IFACE",
             "USE_DEFAULT"     : False,
             "NEED_CONFIRM"    : False,
             "CONDITION"       : False },
            {"CMD_OPTION"      : "ext-net-public-ifmask",
             "USAGE"           : "Public network binded NIC name netmask",
             "PROMPT"          : "Enter Public network bind NIC netmask",
             "OPTION_LIST"     : False,
             "VALIDATORS"      : False,
             "DEFAULT_VALUE"   : "255.255.255.0",
             "MASK_INPUT"      : False,
             "LOOSE_VALIDATION": False,
             "CONF_NAME"       : "CONFIG_EXT_NET_MASK",
             "USE_DEFAULT"     : False,
             "NEED_CONFIRM"    : False,
             "CONDITION"       : False },
            ]
