...
def initConfig(controllerObject):
    ...
    parameters = [
        ...
        {"CMD_OPTION"      : "heat-pgsql-password",
         "USAGE"	         : 'The password used by Heat user to authenticate against PostgreSQL',
         "PROMPT"          : "Enter the password for the Heat PostgreSQL user",
         "OPTION_LIST"     : [],
